...
export declare type ActionCreator<A extends BaseAction> = (
 ...
 * @param options -
 */
export declare function makeActionCreator<A extends BaseAction>(
  name: string,
  /**
...
export declare namespace makeActionCreator {
  export type ArgsMapperFN<A extends BaseAction> = (...arg: any) => { payload?: A["payload"], meta?: A["meta"], [name: string]: any }
  ...
  export interface Options<A extends BaseAction> {
   ...
   */
  export function withDefaults<A extends BaseAction>(args: DefaultsArg): (
    name: string,
    /**
     * A mapper function that enables us to shape the payload and/or the meta
     */
